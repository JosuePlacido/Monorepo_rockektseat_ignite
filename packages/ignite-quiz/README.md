...
It's a app development, with purpose of showing types, of animations and feedbacks with audio and vibration
...
[expo]: https://img.shields.io/badge/47.x-%235D5D5D?style=flat&logo=expo&logoColor=ffffff&label=EXPO&labelColor=1B1F23
[React]: https://img.shields.io/badge/18.2.x-5D5D5D?style=flat&logo=react&label=REACT&labelColor=20232A
[React-Native]: https://img.shields.io/badge/0.70.x-5D5D5D?style=flat&logo=react&label=REACT%20NATIVE&labelColor=20232A
[typescript]: https://img.shields.io/badge/4.x-5D5D5D?style=flat&logo=typescript&logoColor=fff&label=TYPESCRIPT&labelColor=007ACC
