...
Application developed in the Rocketseat course (Ignite). We developed an application that has the responsibility to manage a list of participants of events.
...
[expo]: https://img.shields.io/badge/49.x-%235D5D5D?style=flat&logo=expo&logoColor=ffffff&label=EXPO&labelColor=1B1F23
[React]: https://img.shields.io/badge/18.2.x-5D5D5D?style=flat&logo=react&label=REACT&labelColor=20232A
[React-Native]: https://img.shields.io/badge/0.72.x-5D5D5D?style=flat&logo=react&label=REACT%20NATIVE&labelColor=20232A
