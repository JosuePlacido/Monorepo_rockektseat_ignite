...
import { startLocationTask } from "../../task/backgroundTasks";
			...
			<Container>
				...
				<MessageContent>
					<Message>
						...
						localização para acessar essa funcionalidade. Por favor,
						acesse as configurações do seu dispositivo para conceder
