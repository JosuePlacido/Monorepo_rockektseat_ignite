...
It's a application to buy some types of coffee.

The layout on [FIGMA](<https://www.figma.com/design/JtDAvodi6EDtAo3i0Nt0T4/Coffee-Delivery-%E2%80%A2-Desafio-React-(Copy)?node-id=2-12&node-type=CANVAS&t=tIFhgwl4Q06Mqizb-0>).
...
[Challenge 2: CoffeeDelivery](https://efficient-sloth-d85.notion.site/Desafio-02-Coffee-Delivery-30e42a21fdb44b09a85244fc2c3dbdf9)

1. Make the coffe list availables;
1. Add a specific amount of product on cart;
1. add or remove amount of itens on cart;
1. form to user address;
1. show os amount of itens on cart in header;
1. show the total value of the cart.
...
```bash
	...
	cd packages/coffeedelivery-web
