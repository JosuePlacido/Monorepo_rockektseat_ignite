...
It's a application to manage your focus time.

The layout on [FIGMA](https://www.figma.com/community/file/1138814493269096792).
...
-   building a controlled custom form element
-   create a friendly modal
-   global formatters for money and date
-   request on api
-   hooks performance useCallback, useMemo and memo
-   context selector
