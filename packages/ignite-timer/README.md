...
The layout on [FIGMA](<https://www.figma.com/design/gETLikWAMSxgC1yhIc6VrE/Ignite-Timer-(Community)?node-id=0-1&node-type=CANVAS&t=Ocges5lv6ClVZcPm-0>).
...
-   Styled-components
-   Theming application
-   Variations with object literals
-   Routes and Layouts
