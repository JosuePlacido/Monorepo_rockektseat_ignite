...
[Challenge 3 - Marketspace](https://efficient-sloth-d85.notion.site/Desafio-03-Marketspace-39a72342e820424aaa12d7713ab1d175)

-   login and register users
-   product management
-   list and query products
-   multiple images submissions
...
```bash
	...
	# you cant configure a api address on file:
	# /src/services/api.ts
