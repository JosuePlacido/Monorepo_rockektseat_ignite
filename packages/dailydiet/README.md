...
[Challenge 2 - Daily Diet](https://efficient-sloth-d85.notion.site/Desafio-02-Daily-Diet-98b7d85ec7e9428aa0f9f3bceed4380f)

-   Add new feed
-   edit feed
-   remove feed
-   Show statistics of diet progress
...
-   input styles when focues or filled
-   module resolver for pretty import

### How to use 🚀

```bash
	#access the project folder
	cd packages/dailydiet
